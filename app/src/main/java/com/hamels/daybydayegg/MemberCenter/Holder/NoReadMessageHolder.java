...
public class NoReadMessageHolder extends RecyclerView.ViewHolder {
    public static final String TAG = NoReadMessageHolder.class.getSimpleName();
    ...
    public NoReadMessageHolder(@NonNull View itemView) {
        super(itemView);
