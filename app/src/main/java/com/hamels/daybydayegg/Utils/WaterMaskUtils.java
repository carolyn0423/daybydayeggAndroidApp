...
public class WaterMaskUtils extends Drawable {
     ...
     */
    public WaterMaskUtils(Context context, List<String> labels, int degress, int fontSize) {
        this.labels = labels;
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawColor(Color.parseColor("#CCF3F5F9")); //前面兩碼為透明度
        paint.setColor(Color.parseColor("#FF006000"));
